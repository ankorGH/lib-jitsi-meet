 ...
 * was found.
 */
TraceablePeerConnection.prototype.findSenderByTrack = function(stream) {
...
TraceablePeerConnection.prototype.replaceTrack = function(oldTrack, newTrack) {
    if (browser.isFirefox() && oldTrack && newTrack) {
        ...
        const sender = this.findSenderByTrack(oldTrack.getOriginalStream());
...
TraceablePeerConnection.prototype._handleFirefoxRemoveStream = function(
    ...
    const sender = this.findSenderByTrack(stream);
